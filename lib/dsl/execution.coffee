...
Q.exec = exec = (qObject) ->
  interpretBinary = ({operation, arg1, arg2}) ->
    switch operation
      ...
      when 'lessThan'       then exec(arg1) < exec(arg2)
      when 'lessEquals'     then exec(arg1) <= exec(arg2)
      when 'greaterThan'    then exec(arg1) > exec(arg2)
      when 'greaterEquals'  then exec(arg1) >= exec(arg2)
